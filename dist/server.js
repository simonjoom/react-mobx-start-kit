...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _expressCors = __webpack_require__(8);
  ...
  var _cookieParser = __webpack_require__(151);
  
  var _cookieParser2 = _interopRequireDefault(_cookieParser);
  
  var _stores = __webpack_require__(152);
  
  var _stores2 = _interopRequireDefault(_stores);
  
  var _MuiThemeProvider = __webpack_require__(143);
  ...
  var _reactHotLoader = __webpack_require__(181);
  
  var _mobxReact = __webpack_require__(63);
  
  var _configauth = __webpack_require__(14);
  
  var _config = __webpack_require__(50);
  
  var _config2 = _interopRequireDefault(_config);
  
  var _jsonStringifySafe = __webpack_require__(15);
  
  var _jsonStringifySafe2 = _interopRequireDefault(_jsonStringifySafe);
  
  var _history = __webpack_require__(182);
  
  var _universalRouter = __webpack_require__(183);
  ...
  var proxy = __webpack_require__(184);
  ...
  */
  var setinjectTapEventPlugin = false;
  var css = [];
  var data = {
    lang: 'en',
    title: 'un titre',
  ...
  */
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (!(/(\.ico|\.png|\.js|\.jpg|\.map|\.xml|\.txt)$/.test(req.path) || /socket.*/ || /sockjs-node.*/.test(req.path))) {
                  _context2.next = 8;
                  break;
                }
              ...
              case 8:
                ...
                */
                ...
                store = (0, _jsonStringifySafe2.default)((0, _mobx.toJS)(store, true));
                store = _stores2.default.set(JSON.parse(store));
  ...
  app.get('*', async (req, res, next) => {
   try {
     ...
     const appstate = new AppState(initialState);
       const store = { appstate: appstate.toJson() };
  const context = {
         store,
         insertCss: (...styles) => {
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _appLayout = __webpack_require__(149);
  ...
  var UserSubMenu = function UserSubMenu(s) {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          _Linkmaterial2.default,
          { to: '/Settings', key: '2', hoverColor: '#c2c22F', icon: React.createElement('i', { className: 'mb3 fa fa-sliders' }) },
          'Settings'
        )
      ),
      React.createElement(
        ...
        React.createElement(
          _Linkmaterial2.default,
          { to: '#', key: '3', onClick: handleLogout, hoverColor: '#c2c22F', icon: React.createElement('i', { className: 'mb3 fa fa-sign-out' }) },
          'Sign Out'
        )
      )
    );
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _mobxAjvForm = __webpack_require__(145);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _ui = __webpack_require__(156);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _decorators = __webpack_require__(158);
  
  var _reactTapEventPlugin = __webpack_require__(161);
  ...
  var _AppBar = __webpack_require__(168);
  
  var _AppBar2 = _interopRequireDefault(_AppBar);
  
  var _AppNav = __webpack_require__(169);
  
  var _AppNav2 = _interopRequireDefault(_AppNav);
  
  var _SnackBar = __webpack_require__(170);
  
  var _SnackBar2 = _interopRequireDefault(_SnackBar);
  
  var _AuthModal = __webpack_require__(171);
  
  var _AuthModal2 = _interopRequireDefault(_AuthModal);
  
  var _PostCreateModal = __webpack_require__(172);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _extend = __webpack_require__(159);
  
  var _toggle = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _getMuiTheme = __webpack_require__(163);
  
  var _getMuiTheme2 = _interopRequireDefault(_getMuiTheme);
  
  var _darkBaseTheme = __webpack_require__(164);
  
  var _darkBaseTheme2 = _interopRequireDefault(_darkBaseTheme);
  
  var _lightBaseTheme = __webpack_require__(165);
  
  var _lightBaseTheme2 = _interopRequireDefault(_lightBaseTheme);
  
  var _Material = __webpack_require__(166);
  ...
  var mui =  false ? { userAgent: navigator.userAgent } : {};
  var dark = (0, _getMuiTheme2.default)({}, _lodash2.default.merge(mui, _darkBaseTheme2.default, _Material2.default));
  var light = (0, _getMuiTheme2.default)({}, _lodash2.default.merge(mui, _lightBaseTheme2.default, _Material2.default));
  ...
  var Theme = (_dec = (0, _decorators.toggle)('toggleTheme', 'toggleThemestate'), _dec(_class = (_class2 = function () {
    ...
    (0, _createClass3.default)(Theme, [{
      ...
      value: function getMui() {
        ...
        var b = JSON.parse((0, _stringify2.default)((0, _mobx.toJS)(dark, false)));
        var bool1 = objectEquals(dark, b);
        console.log(bool1);
  
        console.log((typeof window === 'undefined' ? 'undefined' : (0, _typeof3.default)(window)) === 'object' ? 'client-side1' + this.toggleThemestate : 'server-side1' + this.toggleThemestate);
  
        if (!this.toggleThemestate) return dark;else return light;
  ...
  (function () {
    ...
    __REACT_HOT_LOADER__.register(objectEquals, 'objectEquals', '/Users/simon/skiscool_backend/skiscool/react-start-kit/src/store/stores/ui/Theme.js');
  
    __REACT_HOT_LOADER__.register(mui, 'mui', '/Users/simon/skiscool_backend/skiscool/react-start-kit/src/store/stores/ui/Theme.js');
  
    __REACT_HOT_LOADER__.register(dark, 'dark', '/Users/simon/skiscool_backend/skiscool/react-start-kit/src/store/stores/ui/Theme.js');
  
    __REACT_HOT_LOADER__.register(light, 'light', '/Users/simon/skiscool_backend/skiscool/react-start-kit/src/store/stores/ui/Theme.js');
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _client = __webpack_require__(176);
  
  var _client2 = _interopRequireDefault(_client);
  
  var _feathersHooks = __webpack_require__(177);
  ...
  var _client3 = __webpack_require__(179);
  
  var _client4 = _interopRequireDefault(_client3);
  
  var _client5 = __webpack_require__(180);
